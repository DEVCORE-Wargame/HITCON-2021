...
VALUES
('Steven', 'steven@devcore.local', '0912345678', 'FINISH', '0077d9b7ab55a464a32723e7ca201786010f6fc598bb18fa97ba72975bc4a52e', '2021-11-01' , '115 Address with DEVCORE{no.2_bre8k_acc3ss_c0ntrol}'),
('Steven', 'steven@devcore.local', '0912345678', 'ARRIVED', 'b07ac06083bbde4ff4d03a87f76bbad0103f5ffcaef5d1a9aa157881c1fe4187', '2021-11-01', '115 Address with DEVCORE{no.2_bre8k_acc3ss_c0ntrol}'),
('Steven', 'steven@devcore.local', '0912345678', 'SENDING', 'f64744362d8065836a0106e5b50addae4844f5e0a1c0bd7cd59738c9d84ce642', '2021-11-01', '115 Address with DEVCORE{no.2_bre8k_acc3ss_c0ntrol}');


INSERT INTO `backend_users` (`username`, `password`, `description`) VALUE ('admin', 'u=479_p5jV:Fsq(2', 'The administrator ( DEVCORE{no.3_sql_injection_my_passw0rd_is_y0urs} ).');
